  ...
  const companys = [
    {
      ...
      url: "/manufacturer/hetero-drugs-limited",
    },
    { id: 2, name: "Natco pharma ltd", url: "/manufacturer/natco-pharma-ltd" },
    {
      id: 3,
      name: "Dr reddys laboratories ltd",
      url: "/manufacturer/dr-reddys-laboratories-ltd",
    },
    {
      id: 4,
      name: "Emcure pharmaceuticals ltd",
      url: "/manufacturer/emcure-pharmaceuticals-ltd",
    },
    {
      id: 5,
      name: "Mylan pharmaceuticals",
      url: "/manufacturer/mylan-pharmaceuticals",
    },
    { id: 6, name: "Cipla ltd", url: "/manufacturer/cipla-ltd" },
    {
      id: 7,
      name: "Cadila healthcare ltd",
      url: "/manufacturer/cadila-healthcare-ltd",
    },
    {
      id: 8,
      name: "Strides shasun limited",
      url: "/manufacturer/strides-shasun-limited",
    },
    {
      id: 9,
      name: "Sun pharmaceutical industries limited",
      url: "/manufacturer/sun-pharmaceutical-industries-limited",
    },
    ...
    { id: 11, name: "Lupin ltd", url: "/manufacturer/lupin-ltd" },
    {
      ...
      url: "/manufacturer/alkem-laboratories-limited",
    },
    {
      id: 13,
      name: "Aprazer healthcare pvt ltd",
      url: "/manufacturer/aprazer-healthcare-pvt-ltd",
    },
    { id: 14, name: "Wockhardt ltd", url: "/manufacturer/wockhardt-ltd" },
    {
      id: 15,
      name: "Zuventus healthcare ltd",
      url: "/manufacturer/zuventus-healthcare-ltd",
    },
  ];
  ...
  return (
    <>
      <div className="text-center bg-[#35A24D] p-2 mt-10 border-b-2 px-4">
        <h2 className="text-xl text-white font-bold ps-7">Filter By Company</h2>
      </div>
