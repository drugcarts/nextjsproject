    ...
    <>
      ...
      {sendFeedbackList &&
        sendFeedbackList?.send_feedbacks?.map((feedback, i) => (
          <div
            className="flex justify-center items-center mt-4 border-b-[1.5px] p-2 m-3"
            key={i}
          >
              ...
              <div className="flex justify-center items-center">
                ...
                <div className="w-full md:w-2/3">
                  <p className="text-[14px] text-gray-300">
                    {RelativeFormat(feedback?.date)}
                  </p>
                  <h3 className="font-bold text-md md:text-xl">
                    {feedback?.username}
                  </h3>
                  <p className="text-[12px] text-gray-600">
                    {feedback?.ratingStatus}
                  </p>
                </div>
              </div>
            </div>
            <div className="w-full md:w-3/4">
              ...
              <p className="text-sm my-2">{feedback?.comments}</p>
            </div>
          </div>
        ))}
    </>
