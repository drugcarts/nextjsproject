import ClientDoctorbooking from "./ClientDoctorbooking";
import { GetCommonMeta } from "@/services/metatags/commonMeta";

export async function generateMetadata() {
  const url = "doctor-booking";
  try {
    ...
    return {
      ...
      metadataBase: new URL(`https://drugcarts.com/ask-online/${post.url}`),
      alternates: {
        canonical: `https://drugcarts.com/ask-online/${post.url}`,
        languages: {
          en: `https://drugcarts.com/ask-online/${post.url}`,
        },
      },
      ...
      openGraph: {
        ...
        url: `https://drugcarts.com/ask-online/${post.url}`, // adjust if needed
